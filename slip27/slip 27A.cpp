//Slip 27 - A) Create a C++ class College, with data members CollegeId, CollegeName, Establishment_year, University_Name. Overload operators>> and << to accept and display College information.
//Solution:
#include<iostream>
#include<conio.h>
