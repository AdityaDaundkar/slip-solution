//Slip 26 - B) Create a C++ class Time with data members hours, minutes, seconds. Write a C++ program using operator overloading to perform the following: i. != To check whether two Times are equal or not. ii. >> To accept the time. iii. << To display the time.
//Solution:
#include<iostream>
#include<stdio.h>
